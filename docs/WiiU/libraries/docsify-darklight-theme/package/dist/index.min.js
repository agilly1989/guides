window.$docsify.plugins = [].concat((e, o) => {
    let t = {
        ...
        dark: {
            ...
            toogleImage: "url(./WiiU/libraries/docsify-darklight-theme/package/icons/sun.svg)",
        },
        light: {
            accent: "#42b983",
            ...
            coverBackground: "linear-gradient(to left bottom, hsl(118, 100%, 85%) 0%,hsl(181, 100%, 85%) 100%)",
            toogleImage: "url(./WiiU/libraries/docsify-darklight-theme/package/icons/moon.svg)",
        },
    };
